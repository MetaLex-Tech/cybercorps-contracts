...
| File                                                           | SLOC  | Why                                                                                                                                                                                                                                                                                                                                                                                  |
|----------------------------------------------------------------|-------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| src/libs/conditions/secondary/* (16 files)                     | 1,092 | Threshold + closing conditions evaluated at postOffer / acceptOffer / finalize; includes KillSwitchCondition (kill switch), HolderCapCondition (reworked in PR #117 to use the new look-through tally), HoldingPeriodCondition (now reads acquisition timestamps), TimeSettlementPeriodCondition, EligibilityCondition (catch-all KYC/AML, tax, ERISA), Reg S, Rule 144, CFIUS, etc. |
...
| src/IssuanceManager.sol                                | forceScripBurn                                                                                                    | Privileged burn of user securities plus the matching vault withdrawal                                                                  |
| src/CyberScrip.sol                                     | _update / mint / burnFrom / forceTransfer / forceBurn / setFrozen / setMaxHolderCount / canTransfer               | Scrip transfer restrictions, holder caps, freeze; compliance setters now direct (`onlyIssuanceManagerOrAdmin`)                         |
